        ...
        <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto animate-in fade-in duration-700">
            ...
            {activeTab === 'workshops' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in slide-in-from-bottom-4">
                    {myBookings.length === 0 ? (
                        <div className="col-span-full py-20 text-center opacity-30 italic serif text-2xl">
                            No masterclasses booked yet.
                        </div>
                    ) : myBookings.map(b => (
                        <div key={b.id} className="bg-white p-8 border border-[#E5E5E5] flex flex-col sm:flex-row gap-8 items-start hover:shadow-lg transition-shadow">
                            <div className="flex-grow">
                                <span className="text-[10px] uppercase tracking-widest text-[#8B735B] font-bold">Booking Confirmed</span>
                                <h3 className="text-xl serif mt-2 mb-4">{b.workshopTitle}</h3>
                                <div className="space-y-2 mb-6">
                                    <div className="flex items-center gap-2 text-xs text-[#666]">
                                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                        <span>Reservation ID: {b.id}</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-xs text-[#666]">
                                ...
                                <button
                                    ...
                                    className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#2C2C2C] border-b border-[#2C2C2C] pb-0.5 hover:text-[#8B735B] hover:border-[#8B735B] transition-all"
                                >
                                    Post Review
                                </button>
                            </div>
